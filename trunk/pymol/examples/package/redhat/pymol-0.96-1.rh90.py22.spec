...
cp -dprv scripts ${RPM_BUILD_ROOT}/usr/lib/python2.2/site-packages/pymol/
echo pymol/modules > ${RPM_BUILD_ROOT}/usr/lib/python2.2/site-packages/pymol.pth
...
/usr/lib/python2.2/site-packages/pymol.pth
