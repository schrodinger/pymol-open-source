...
int ExecutiveIterate(PyMOLGlobals * G, char *s1, char *expr, int read_only, int quiet,
                     PyObject * space);
int ExecutiveIterateList(PyMOLGlobals * G, char *s1, PyObject * list, int read_only,
                         int quiet, PyObject * space);
int ExecutiveSelectList(PyMOLGlobals * G, char *sele_name, char *s1, int *list,
...
int ExecutiveSetSetting(PyMOLGlobals * G, int index, PyObject * tuple,
                        char *sele, int state, int quiet, int updates);
...
int ExecutiveRMS(PyMOLGlobals * G, char *sele1, char *sele2, int mode, float refine,
...
int ExecutiveOrigin(PyMOLGlobals * G, char *name, int preserve, char *oname, float *pos,
                    int state);
int ExecutiveCenter(PyMOLGlobals * G, char *name, int state, int inclusive, float animate,
                    float *pos, int quiet);
...
int ExecutiveSeleToObject(PyMOLGlobals * G, char *name, char *s1, int source, int target,
...
PyObject *ExecutiveGetSettingOfType(PyMOLGlobals * G, int index, char *object, int state,
                                    int type);
...
int ExecutiveTransformObjectSelection(PyMOLGlobals * G, char *name, int state, char *s1,
...
int ExecutiveIsomeshEtc(PyMOLGlobals * G,
                        char *volume_name, char *map_name, float lvl,
                        char *sele, float fbuf, int state,
                        float carve, int map_state, int quiet,
                        int mesh_mode, int box_mode, float alt_lvl);
