...
class TestPh4(testing.PyMOLTestCase):
    ...
    def test_load_hypothesis_xyz(self):
        ...
        ph4.load_hypothesis_xyz(
            self.datafile("phase/hypothesis.xyz"), ref=self.datafile("phase/ALL.xyz")
        )
        extent = cmd.get_extent("hypothesis")
        self.assertArrayEqual(
            extent, [[-4.218, -2.742, -3.702], [10.536, 6.152, 3.536]], delta=1e-2
        )
    ...
    def test_load_hypothesis_xvol(self):
        ...
        self.assertArrayEqual(
            extent, [[33.622, 23.055, 23.741], [54.344, 38.530, 37.948]], delta=1e-2
        )
