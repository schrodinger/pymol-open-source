...
class TestMovie(testing.PyMOLTestCase):
    ...
    def test_nutate(self):
        self.skipTest(
            "TODO"
        )  # movie.nutate(first,last,angle=30,phase=0,loop=1,shift=math.pi/2.0):

    def test_screw(self):
        self.skipTest(
            "TODO"
        )  # movie.screw(first,last,step=1,angle=30,phase=0,loop=1,axis='y'):
    ...
    def test_add_nutate(self):
        self.skipTest(
            "TODO"
        )  # movie.add_nutate(duration=8.0, angle=30.0, spiral=0, loop=1,
    ...
    def test_produce(self):
        self.skipTest(
            "TODO"
        )  # movie.produce(filename, mode='', first=0, last=0, preserve=0,
