...
class TestMMPyMOLx(testing.PyMOLTestCase):
    ...
    def testLoadMTZ(self):
        cmd.load_mtz(
            self.datafile("4rwb.mtz"), "foo", "cryst_1/data_1/FP", "cryst_1/data_1/PHIC"
        )
        ...
        self.assertArrayEqual(
            extent,
            [[0.000, 0.000, 0.000], [37.585, 40.586, 27.214]],
            delta=1e-3,
            msg="extend wrong",
        )
        ...
        self.assertArrayEqual(
            mmms, [-2.6767, 4.9998, 0.0, 1.0], delta=1e-4, msg="histogram wrong"
        )
