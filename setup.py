...
# have to be moved. Full explanation
...
parser.add_argument(
    "--glut", dest="no_glut", action="store_false", help="link with GLUT (legacy GUI)"
)
parser.add_argument(
    "--no-osx-frameworks",
    dest="osx_frameworks",
...
parser.add_argument("--testing", action="store_true", help="Build C-level tests")
