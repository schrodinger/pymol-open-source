...
class MAE(Storage):
    ...
    def _read_m_atom(self, m_atom, model):
        ...
        if (
            "r_m_x_coord" in at_ent
            and "r_m_y_coord" in at_ent
            and "r_m_z_coord" in at_ent
        ):
    ...
    def _read_m_bond(self, m_bond, model):
        ...
        if len(bd_dat[0]):  # not empty right?
            if "i_m_from" in bd_ent and "i_m_to" in bd_ent and "i_m_order" in bd_ent:
