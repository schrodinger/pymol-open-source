...
print "PARM99 for DNA,RNA,AA, organic molecules, TIP3P wat. Polariz.& LP incl.02/04/99"
...
'JA-TA  427.0    1.680       WLD gross estimate',
...
# missing angle terms
l = [
'J3-QN-A     50.0      109.50    TEMPORARY NUSIANCE REMOVAL',
...
'D3-DJ-Q2    70.0      120.00    WLD gross estimate',
...
'D4-T2-D3    62.0      103.00    WLD gross estimate',
...
'D4-T2-DJ    62.0      103.00    WLD gross estimate',
...
'Q2-T4-Q2   140.0      119.70    WLD from Q1-T4-Q1',
...
'X -J3-Q2-X    2    4.20        180.0             2.         WLD from X -DA-Q2-X ',
