        ...
        while 1:
            ...
            for a in need[0]:  # missing only one atom
                ...
                if at1.text_type in bondfield.nonlinear:
                    ...
                    if near:
                        ...
                        if (
                            at3.text_type in bondfield.planer
                            ...
                            at2.coord = add(
                                at1.coord,
                                scale(v, bnd_len[(at1.text_type, at2.text_type)]),
                            )
                        ...
                        v = normalize(add(p0, v))
                        at2.coord = add(
                            at1.coord, scale(v, bnd_len[(at1.text_type, at2.text_type)])
                        )
                    else:
                        at2.coord = random_sphere(
                            at1.coord, bnd_len[(at1.text_type, at2.text_type)]
                        )
            ...
            for a in need[2]:  # missing 3 atoms
                ...
                if near:  # 1-4 present
                    ...
                    at2.coord = random_sphere(
                        at2.coord, bnd_len[(at1.text_type, at2.text_type)]
                    )
