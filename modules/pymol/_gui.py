...
class PyMOLDesktopGUI(object):
    ...
    def new_window(self, extra_argv=()):
        ...
        args = [python, pymol.__file__, "-N", pymol.invocation.options.gui] + list(
            extra_argv
        )
                    ...
                    (
                        ...
                        [
                            ...
                            (
                                "command",
                                "File Browser",
                                lambda: self.cmd.system(file_browser_cmd),
                            ),
                        ],
                    ),
                    ("separator",),
                    ...
                    (
                        ...
                        [
                            ...
                            (
                                "command",
                                "Sulfonyl [Alt-3]",
                                "editor.attach_fragment('pk1','sulfone',3,1)",
                            ),
            ...
            (
                ...
                [
                                ...
                                [
                                    (
                                        ...
                                        [
                                            (
                                                "command",
                                                "%d deg. over %d sec." % (angle, sec),
                                                lambda s="set sweep_angle,%d;cmd.movie.add_scenes(None, %d, rock=%d, start=%%d)" % (
                                                    angle,
                                                    sec,
                                                    rock,
                                                ): self.mvprg(
                                ...
                                + [
                                    (
                                        ...
                                        [
                                            (
                                                "command",
                                                str(val) + " seconds each",
                                                lambda s="movie.add_scenes(None,%.1f," % val: self.mvprg(
                                                    s + "rock=0,start=%d)"
                                                ),
                                            )
                    ...
                    (
                        ...
                        "Frame Rate",
                        [
                            ("radio", "30 FPS", "movie_fps", 30.0),
                            ("radio", "15 FPS", "movie_fps", 15.0),
                            ("radio", "5 FPS", "movie_fps", 5.0),
                            ("radio", "1 FPS", "movie_fps", 1.0),
                            ("radio", "0.3 FPS", "movie_fps", 0.3),
                            ("separator",),
            ...
            (
                ...
                [
                    ...
                    (
                        "command",
                        "Keyboard Shortcuts...",
                        self.shortcut_menu_edit_dialog,
                    ),
                    ...
                    (
                        ...
                        [
                            ...
                            (
                                "menu",
                                "Sphere",
                                transparency_menu("sphere_transparency"),
                            ),
                            (
                                "menu",
                                "Cartoon",
                                transparency_menu("cartoon_transparency"),
                            ),
                    ...
                    (
                        ...
                        [
                            (
                                "command",
                                "Representations",
                                lambda: cmd.wizard("demo", "reps"),
                            ),
                            (
                                "command",
                                "Cartoon Ribbons",
                                lambda: cmd.wizard("demo", "cartoon"),
                            ),
                            (
                                "command",
                                "Roving Detail",
                                lambda: cmd.wizard("demo", "roving"),
                            ),
                            (
                                "command",
                                "Roving Density",
                                lambda: cmd.wizard("demo", "roving_density"),
                            ),
                            (
                                "command",
                                "Transparency",
                                lambda: cmd.wizard("demo", "trans"),
                            ),
                            (
                                "command",
                                "Ray Tracing",
                                lambda: cmd.wizard("demo", "ray"),
                            ),
                            (
                                "command",
                                "Sculpting",
                                lambda: cmd.wizard("demo", "sculpt"),
                            ),
                            (
                                "command",
                                "Scripted Animation",
                                lambda: cmd.wizard("demo", "anime"),
                            ),
                            (
                                "command",
                                "Electrostatics",
                                lambda: cmd.wizard("demo", "elec"),
                            ),
                            (
                                "command",
                                "Compiled Graphics Objects",
                                lambda: cmd.wizard("demo", "cgo"),
                            ),
                            (
                                "command",
                                "Molscript/Raster3D Input",
                                lambda: cmd.wizard("demo", "raster3d"),
                            ),
                            ("separator",),
                            (
                                "command",
                    ...
                    (
                        ...
                        [
                            ...
                            (
                                ...
                                "Core Commands",
                                lambda: webbrowser.open(
                                    "http://pymol.org/d/command:core_set"
                                ),
                            ),
                            (
                                "command",
                                "Settings",
                                lambda: webbrowser.open("http://pymol.org/d/setting"),
                            ),
                            (
                                "command",
                                "Atom Selections",
                                lambda: webbrowser.open("http://pymol.org/d/selection"),
                            ),
                            (
                                "command",
                                "Commands",
                                lambda: webbrowser.open("http://pymol.org/d/command"),
                            ),
                            (
                                "command",
                                "Launching",
                                lambda: webbrowser.open("http://pymol.org/d/launch"),
                            ),
                            (
                                "command",
                                "Concepts",
                                lambda: webbrowser.open("http://pymol.org/d/concept"),
                            ),
                            (
                                "command",
                                "A.P.I. Methods",
                                lambda: webbrowser.open("http://pymol.org/d/api"),
                            ),
                        ],
                    ),
                    ("separator",),
    ...
    def recent_filenames(self):
        ...
        return [
            row[0]
            for row in c.execute("SELECT filename FROM recent ORDER BY timestamp DESC")
        ]
