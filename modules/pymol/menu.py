...
def extract(self_cmd, sele):
    return [
        ...
        [
            1,
            "extend 1",
            'cmd.create(None,"(' + sele + ') extend 1",extract="' + sele + '",zoom=0)',
        ],
        [
            1,
            "byres extend 1",
            'cmd.create(None,"byres (('
            + sele
            + ') extend 1)",extract="'
            + sele
            + '",zoom=0)',
...
def store_with_state(self_cmd, obj="", frame=0):
    ...
    result = [
        ...
        [
            1,
            "current",
            'cmd.mview("store",object="' + obj + '",state=-1,first=%s)' % (frame),
        ],
        [0, "", ""],
        ...
        result.extend(
            [
                [
                    1,
                    str(n_state),
                    'cmd.mview("store",object="'
                    + obj
                    + '",state=%d,first=%s)' % (n_state, frame),
                ],
                [0, "", ""],
            ]
        )
...
def mouse_config(self_cmd):
    result = [
        [1, "3-Button Motions", 'cmd.config_mouse("three_button_motions")'],
        [1, "3-Button Editing", 'cmd.config_mouse("three_button_editing")'],
        [1, "3-Button Viewing", 'cmd.mouse("three_button_viewing")'],
        [1, "3-Button Lights", 'cmd.mouse("three_button_lights")'],
        [1, "3-Button All Modes", 'cmd.config_mouse("three_button_all_modes")'],
        [0, "", ""],
        [1, "2-Button Editing", 'cmd.config_mouse("two_button_editing")'],
        [1, "2-Button Viewing", 'cmd.config_mouse("two_button_viewing")'],
...
def smooth(self_cmd, extra=""):
    return [
        [1, "a little", 'cmd.mview("smooth"%s)' % extra],
        ...
        [
            ...
            [
                ...
                [
                    1,
                    flag_ignore_action,
                    f'cmd.flag("ignore",{sele!r},{flag_ignore_action!r});cmd.rebuild({sele!r})',
                ],
                [0, "", ""],
...
def mol_as(self_cmd, sele):
    return [[2, "As:", ""]] + rep_action(self_cmd, sele, "show_as")


def mol_toggle(self_cmd, sele):
    return [[2, "As:", ""]] + rep_action(self_cmd, sele, "toggle")
...
def mol_show(self_cmd, sele):
    return (
        [[2, "Show:", ""], [1, "as", mol_as(self_cmd, sele)], [0, "", ""]]
        ...
        + [
            ...
            [
                ...
                "side chain",
                show_misc(
                    self_cmd, "((byres (" + sele + "))&(sc.|" + sele_ms_shared + "))"
                ),
            ],
            [
                1,
    ...
    return (
        ...
        + [
            ...
            [
                1,
                "main chain",
                'cmd.hide("((byres (' + sele + "))&(bb.&!" + sele_ms_shared + '))")',
            ],
            [
                1,
                "side chain",
                'cmd.hide("((byres (' + sele + "))&(sc.&!" + sele_ms_shared + '))")',
            ],
...
def by_elem2(self_cmd, sele):
    return [
        ...
        [
            1,
            "\\494C\\777H\\229N\\922O\\950S...",
            'util.cba(10,"' + sele + '",_self=cmd)',
        ],  # lime
        [
            1,
            "\\155C\\777H\\229N\\922O\\950S...",
            'util.cba(5262,"' + sele + '",_self=cmd)',
        ],  # deepteal
        [
            1,
            "\\904C\\777H\\229N\\922O\\950S...",
            'util.cba(12,"' + sele + '",_self=cmd)',
        ],  # hotpink
        [
            1,
            "\\983C\\777H\\229N\\922O\\950S...",
            'util.cba(36,"' + sele + '",_self=cmd)',
        ],  # yelloworange
        [
            1,
            "\\525C\\777H\\229N\\922O\\950S...",
            'util.cba(5271,"' + sele + '",_self=cmd)',
        ],  # violetpurple
        [
            1,
            "\\666C\\777H\\229N\\922O\\950S...",
            'util.cba(124,"' + sele + '",_self=cmd)',
        ],  # grey70
        [
            1,
            "\\049C\\777H\\229N\\922O\\950S...",
            'util.cba(17,"' + sele + '",_self=cmd)',
        ],  # marine
        [
            1,
            "\\760C\\777H\\229N\\922O\\950S...",
            'util.cba(18,"' + sele + '",_self=cmd)',
        ],  # olive
    ]
...
def by_elem3(self_cmd, sele):
    return [
        ...
        [
            1,
            "\\564C\\777H\\229N\\922O\\950S...",
            'util.cba(5270,"' + sele + '",_self=cmd)',
        ],  # smudge
        [
            1,
            "\\077C\\777H\\229N\\922O\\950S...",
            'util.cba(20,"' + sele + '",_self=cmd)',
        ],  # teal
        [
            1,
            "\\644C\\777H\\229N\\922O\\950S...",
            'util.cba(5272,"' + sele + '",_self=cmd)',
        ],  # dirtyviolet
        [
            1,
            "\\976C\\777H\\229N\\922O\\950S...",
            'util.cba(52,"' + sele + '",_self=cmd)',
        ],  # wheat
        [
            1,
            "\\944C\\777H\\229N\\922O\\950S...",
            'util.cba(5258,"' + sele + '",_self=cmd)',
        ],  # deepsalmon
        [
            1,
            "\\978C\\777H\\229N\\922O\\950S...",
            'util.cba(5274,"' + sele + '",_self=cmd)',
        ],  # lightpink
        [
            1,
            "\\499C\\777H\\229N\\922O\\950S...",
            'util.cba(5257,"' + sele + '",_self=cmd)',
        ],  # aquamarine
        [
            1,
            "\\994C\\777H\\229N\\922O\\950S...",
            'util.cba(5256,"' + sele + '",_self=cmd)',
        ],  # paleyellow
    ]
...
def by_elem4(self_cmd, sele):
    return [
        ...
        [
            1,
            "\\094C\\777H\\229N\\922O\\950S...",
            'util.cba(15,"' + sele + '",_self=cmd)',
        ],  # limegreen
        [
            1,
            "\\247C\\777H\\229N\\922O\\950S...",
            'util.cba(5277,"' + sele + '",_self=cmd)',
        ],  # skyblue
        [
            1,
            "\\824C\\777H\\229N\\922O\\950S...",
            'util.cba(5279,"' + sele + '",_self=cmd)',
        ],  # warmpink
        [
            1,
            "\\792C\\777H\\229N\\922O\\950S...",
            'util.cba(5276,"' + sele + '",_self=cmd)',
        ],  # limon
        [
            1,
            "\\949C\\777H\\229N\\922O\\950S...",
            'util.cba(53,"' + sele + '",_self=cmd)',
        ],  # violet
        [
            1,
            "\\889C\\777H\\229N\\922O\\950S...",
            'util.cba(5278,"' + sele + '",_self=cmd)',
        ],  # bluewhite
        [
            1,
            "\\297C\\777H\\229N\\922O\\950S...",
            'util.cba(5275,"' + sele + '",_self=cmd)',
        ],  # greencyan
        [
            1,
            "\\653C\\777H\\229N\\922O\\950S...",
            'util.cba(5269,"' + sele + '",_self=cmd)',
        ],  # sand
    ]
...
def by_elem5(self_cmd, sele):
    return [
        ...
        [
            1,
            "\\252C\\777H\\229N\\922O\\950S...",
            'util.cba(22,"' + sele + '",_self=cmd)',
        ],  # forest
        [
            1,
            "\\466C\\777H\\229N\\922O\\950S...",
            'util.cba(5266,"' + sele + '",_self=cmd)',
        ],  # lightteal
        [
            1,
            "\\755C\\777H\\229N\\922O\\950S...",
            'util.cba(5280,"' + sele + '",_self=cmd)',
        ],  # darksalmon
        [
            1,
            "\\570C\\777H\\229N\\922O\\950S...",
            'util.cba(5267,"' + sele + '",_self=cmd)',
        ],  # splitpea
        [
            1,
            "\\634C\\777H\\229N\\922O\\950S...",
            'util.cba(5268,"' + sele + '",_self=cmd)',
        ],  # raspberry
        [
            1,
            "\\555C\\777H\\229N\\922O\\950S...",
            'util.cba(104,"' + sele + '",_self=cmd)',
        ],  # grey50
        [
            1,
            "\\226C\\777H\\229N\\922O\\950S...",
            'util.cba(23,"' + sele + '",_self=cmd)',
        ],  # deepblue
        [
            1,
            "\\632C\\777H\\229N\\922O\\950S...",
            'util.cba(51,"' + sele + '",_self=cmd)',
        ],  # brown
    ]
...
def by_elem6(self_cmd, sele):
    return [
        ...
        [
            1,
            "\\191C\\911H\\229N\\922O\\950S...",
            'util.cbh("tv_red","' + sele + '",_self=cmd)',
        ],  # tv_red
        [
            1,
            "\\191C\\917H\\229N\\922O\\950S...",
            'util.cbh("lightmagenta","' + sele + '",_self=cmd)',
        ],  # lightmagenta
        [
            1,
            "\\191C\\119H\\229N\\922O\\950S...",
            'util.cbh("tv_blue","' + sele + '",_self=cmd)',
        ],  # tv_blue
        [
            1,
            "\\191C\\940H\\229N\\922O\\950S...",
            'util.cbh("orange","' + sele + '",_self=cmd)',
        ],  # orange
        [
            1,
            "\\191C\\870H\\229N\\922O\\950S...",
            'util.cbh("olive","' + sele + '",_self=cmd)',
        ],  # olive
        [
            1,
            "\\191C\\088H\\229N\\922O\\950S...",
            'util.cbh("teal","' + sele + '",_self=cmd)',
        ],  # teal
        [
            1,
            "\\191C\\521H\\229N\\922O\\950S...",
            'util.cbh("chocolate","' + sele + '",_self=cmd)',
        ],  # chocolate
        [
            1,
            "\\191C\\000H\\229N\\922O\\950S...",
            'util.cbh("black","' + sele + '",_self=cmd)',
        ],  # black
    ]
...
def by_elem(self_cmd, sele):
    return [
        ...
        [
            1,
            "\\292C\\777H\\229N\\922O\\950S...",
            'util.cba(33,"' + sele + '",_self=cmd)',
        ],  # tv_green
        [
            1,
            "\\099C\\777H\\229N\\922O\\950S...",
            'util.cba(5,"' + sele + '",_self=cmd)',
        ],  # cyan
        [
            1,
            "\\927C\\777H\\229N\\922O\\950S...",
            'util.cba(154,"' + sele + '",_self=cmd)',
        ],  # lightmagenta
        [
            1,
            "\\990C\\777H\\229N\\922O\\950S...",
            'util.cba(6,"' + sele + '",_self=cmd)',
        ],  # yellow
        [
            1,
            "\\955C\\777H\\229N\\922O\\950S...",
            'util.cba(9,"' + sele + '",_self=cmd)',
        ],  # salmon
        [
            1,
            "\\888C\\777H\\229N\\922O\\950S...",
            'util.cba(144,"' + sele + '",_self=cmd)',
        ],  # grey90
        [
            1,
            "\\449C\\777H\\229N\\922O\\950S...",
            'util.cba(11,"' + sele + '",_self=cmd)',
        ],  # slate
        [
            1,
            "\\962C\\777H\\229N\\922O\\950S...",
...
def by_ss(self_cmd, sele):
    return [
        ...
        [
            1,
            "\\900Helix \\990Sheet \\090Loop",
            'util.cbss("' + sele + '","red","yellow","green",_self=cmd)',
        ],
        [
            1,
            "\\099Helix \\909Sheet \\955Loop",
            'util.cbss("' + sele + '","cyan","magenta","salmon",_self=cmd)',
        ],
        [
            1,
            "\\099Helix \\900Sheet \\909Loop",
            'util.cbss("' + sele + '","cyan","red","magenta",_self=cmd)',
        ],
    ]
...
def spectrum(self_cmd, sele):
    r = [
        ...
        [
            1,
            "\\900r\\950a\\990i\\090n\\099b\\059o\\009w\\888(elem C)",
            'cmd.spectrum("count",selection="(' + sele + ')&elem C")',
        ],
        [
            1,
            "\\900r\\950a\\990i\\090n\\099b\\059o\\009w\\888(*/CA)",
            'cmd.spectrum("count",selection="(' + sele + ')&*/CA")',
        ],
        [
            1,
            "\\900r\\950a\\990i\\090n\\099b\\059o\\009w",
        ...
        [
            1,
            "b-factors(*/CA)",
            'cmd.spectrum("b",selection="((' + sele + ')&*/CA)",quiet=0)',
        ],
        [0, "", ""],
...
def by_chain(self_cmd, sele):
    ...
    return [
        ...
        [
            1,
            "\\900b\\950y \\090c\\099h\\059a\\009i\\705n\\888(elem C)",
            'util.color_chains("(' + sele + ' and elem C)",_self=cmd)',
        ],
        [
            1,
            "\\900b\\950y \\090c\\099h\\059a\\009i\\705n\\888(*/CA)",
            'util.color_chains("(' + sele + ' and name CA)",_self=cmd)',
        ],
        [
            1,
            "\\900b\\950y \\090c\\099h\\059a\\009i\\705n",
            'util.color_chains("(' + sele + ')",_self=cmd)',
        ],
        [0, "", ""],
        [
            1,
            "\\900c\\950h\\990a\\090i\\099n\\059b\\009o\\705w\\888s",
        ...
        [
            1,
            by_segi + "(elem C)",
            'cmd.spectrum("segi","rainbow","(' + sele + ') & elem C")',
        ],
...
def colorramps(self_cmd, expr):
    with menucontext(self_cmd) as mc:
        return [[1, name, expr.format(name)] for name in mc.ramps]
...
def all_colors_generic(self_cmd, expr):
    r = [
        [
            ...
            "\\" + c_list[0][0] + gn,
            [[2, gn.capitalize(), ""]]
            + [[1, "\\" + c3 + cn, expr.format(cn)] for (c3, cn) in c_list],
        ]
...
def vol_color(self_cmd, sele):
    ...
    return [
        ...
        [0, "", ""],
    ] + [[1, p, 'cmd.volume_color(%s, "%s")' % (rsele, p)] for p in sorted(namedramps)]
...
def color_auto(self_cmd, sele):
    return [
        ...
        [
            1,
            "\\900b\\950y \\090o\\099b\\059j\\999(elem C)",
            'util.color_objs("(' + sele + ' and elem C)",_self=cmd)',
        ],
        [
            1,
            "\\900b\\950y \\090o\\099b\\059j",
...
def mol_color(self_cmd, sele):
    with menucontext(self_cmd, sele):
        return [
            ...
            [
                1,
                "\\900s\\950p\\990e\\090c\\099t\\059r\\009u\\555m",
                spectrum(self_cmd, sele),
            ],
            [0, "", ""],
            ...
            [
                ...
                [
                    ...
                    [
                        1,
                        "off",
                        'cmd.set("%s_negative_visible",0,"%s",quiet=0);' % (rep, name),
                    ],
                    [0, "", ""],
                ]
                + negative,
...
def preset_ligand_sites(self_cmd, sele):
    return [
        ...
        [
            1,
            "transparent surface",
            'preset.ligand_sites_trans("' + sele + '",_self=cmd)',
        ],
        [
            1,
            "transparent (better)",
            'preset.ligand_sites_trans_hq("' + sele + '",_self=cmd)',
        ],
        [0, "", ""],
...
def hydrogens(self_cmd, sele):
    return [
        ...
        [
            1,
            "add polar",
            'cmd.h_add("' + sele + ' & (don.|acc.)");cmd.sort("' + sele + ' extend 1")',
        ],
        [1, "remove", 'cmd.remove("(' + sele + ') and hydro")'],
        [
            1,
            "remove nonpolar",
            'cmd.remove("' + sele + ' & hydro & not nbr. (don.|acc.)")',
        ],
    ]
        ...
        [
            ...
            [
                ...
                [
                    1,
                    "formal charge sum",
                    'util.sum_formal_charges("' + sele + '",quiet=0,_self=cmd)',
                ],
                [
                    1,
                    "partial charges sum",
                    'util.sum_partial_charges("' + sele + '",quiet=0,_self=cmd)',
                ],
            ],
        ],
        [
            ...
            [
                ...
                [
                    1,
                    "molecular",
                    'util.get_area("' + sele + '", -1, 0, quiet=0,_self=cmd)',
                ],
                [
                    1,
                    "solvent accessible",
                    'util.get_sasa("' + sele + '",quiet=0,_self=cmd)',
                ],
                [
                    1,
                    "per residue (relative sol. acc.)",
                    'cmd.get_sasa_relative("' + sele + '",quiet=0,_self=cmd)',
                ],
            ],
        ],
        [
            ...
            [
                ...
                [
                    ...
                    'util.compute_mass("'
                    + sele
                    + '",implicit=False,quiet=0,_self=cmd)',
                ],
                [
                    1,
                    "with missing hydrogens",
                    'util.compute_mass("' + sele + '",implicit=True,quiet=0,_self=cmd)',
                ],
            ],
        ],
    ]
...
def vacuum(self_cmd, sele):
    return [
        ...
        [
            ...
            'util.protein_vacuum_esp("' + sele + '",mode=2,quiet=0,_self=cmd)',
        ],
...
def symmetry(self_cmd, sele):
    return [
        ...
        [
            1,
            "within 4 A",
            'cmd.symexp("' + sele + '_","' + sele + '","' + sele + '",cutoff=4,segi=1)',
        ],
        [
            1,
            "within 5 A",
            'cmd.symexp("' + sele + '_","' + sele + '","' + sele + '",cutoff=5,segi=1)',
        ],
        [
            1,
            "within 6 A",
            'cmd.symexp("' + sele + '_","' + sele + '","' + sele + '",cutoff=6,segi=1)',
        ],
        [
            1,
            "within 8 A",
            'cmd.symexp("' + sele + '_","' + sele + '","' + sele + '",cutoff=8,segi=1)',
        ],
        [
            1,
            "within 12 A",
...
def mol_assign(self_cmd, sele):
    return [
        ...
        [
            1,
            "Amber 99 atomic properties",
            'util.assign_amber99("' + sele + '",_self=cmd)',
        ],
    ]
...
def selection(self_cmd, sele):
    return [
        ...
        [
            1,
            "polymer",
            'cmd.select("' + sele + '_polymer","(' + sele + ') and polymer")',
        ],
        [
            1,
            "organic",
            'cmd.select("' + sele + '_organic","(' + sele + ') and organic")',
        ],
        [
            1,
            "solvent",
            'cmd.select("' + sele + '_solvent","(' + sele + ') and solvent")',
        ],
        [
            1,
            "polar hydrogens",
        ...
        [
            ...
            + '_npolar_h","('
            + sele
            + ') and (e. H and (not bound_to e. S+O+N))")',
        ],
        [1, "donors", 'cmd.select("' + sele + '_donors","(' + sele + ') and hbd")'],
        [
            1,
            "acceptors",
            'cmd.select("' + sele + '_acceptors","(' + sele + ') and hba")',
        ],
...
def complete(self_cmd, sele):
    return [
        ...
        [
            1,
            "C-alphas",
            'cmd.select("' + sele + '","(bycalpha ' + sele + ')",enable=1)',
        ],
    ]
...
def restrict(self_cmd, sele):
    return [
        ...
        [
            1,
            "to visible",
            'cmd.select("' + sele + '","(' + sele + ') and vis",enable=1)',
        ],
        [0, "", ""],
        [
            1,
            "to polymer",
            'cmd.select("' + sele + '","(' + sele + ') and polymer",enable=1)',
        ],
        [
            1,
            "to solvent",
            'cmd.select("' + sele + '","(' + sele + ') and solvent",enable=1)',
        ],
        [
            1,
            "to organic",
            'cmd.select("' + sele + '","(' + sele + ') and organic",enable=1)',
        ],
        [
            1,
            "to inorganic",
            'cmd.select("' + sele + '","(' + sele + ') and inorganic",enable=1)',
        ],
    ]
...
def exclude(self_cmd, sele):
    return [
        ...
        [
            1,
            "polymer",
            'cmd.select("' + sele + '","(' + sele + ') and not organic",enable=1)',
        ],
        [
            1,
            "solvent",
            'cmd.select("' + sele + '","(' + sele + ') and not solvent",enable=1)',
        ],
        [
            1,
            "organic",
...
def expand(self_cmd, sele):
    return [
        ...
        [
            1,
            "by 12 A",
            'cmd.select("' + sele + '","(' + sele + ' expand 12)",enable=1)',
        ],
        [
            1,
            "by 20 A",
            'cmd.select("' + sele + '","(' + sele + ' expand 20)",enable=1)',
        ],
        [0, "", ""],
        [
            1,
            "by 4 A, residues",
            'cmd.select("' + sele + '","(byres (' + sele + ' expand 4))",enable=1)',
        ],
        [
            1,
            "by 5 A, residues",
            'cmd.select("' + sele + '","(byres (' + sele + ' expand 5))",enable=1)',
        ],
        [
            1,
            "by 6 A, residues",
            'cmd.select("' + sele + '","(byres (' + sele + ' expand 6))",enable=1)',
        ],
        [
            1,
            "by 8 A, residues",
            'cmd.select("' + sele + '","(byres (' + sele + ' expand 8))",enable=1)',
        ],
        [
            1,
            "by 12 A, residues",
            'cmd.select("' + sele + '","(byres (' + sele + ' expand 12))",enable=1)',
        ],
        [
            1,
            "by 20 A, residues",
            'cmd.select("' + sele + '","(byres (' + sele + ' expand 20))",enable=1)',
        ],
    ]
...
def around(self_cmd, sele):
    return [
        ...
        [
            1,
            "atoms within 4 A",
            'cmd.select("' + sele + '","(' + sele + ' around 4)",enable=1)',
        ],
        [
            1,
            "atoms within 5 A",
            'cmd.select("' + sele + '","(' + sele + ' around 5)",enable=1)',
        ],
        [
            1,
            "atoms within 6 A",
            'cmd.select("' + sele + '","(' + sele + ' around 6)",enable=1)',
        ],
        [
            1,
            "atoms within 8 A",
            'cmd.select("' + sele + '","(' + sele + ' around 8)",enable=1)',
        ],
        [
            1,
            "atoms within 12 A",
            'cmd.select("' + sele + '","(' + sele + ' around 12)",enable=1)',
        ],
        [
            1,
            "atoms within 20 A",
            'cmd.select("' + sele + '","(' + sele + ' around 20)",enable=1)',
        ],
        [0, "", ""],
        [
            1,
            "residues within 4 A",
            'cmd.select("' + sele + '","(byres (' + sele + ' around 4))",enable=1)',
        ],
        [
            1,
            "residues within 5 A",
            'cmd.select("' + sele + '","(byres (' + sele + ' around 5))",enable=1)',
        ],
        [
            1,
            "residues within 6 A",
            'cmd.select("' + sele + '","(byres (' + sele + ' around 6))",enable=1)',
        ],
        [
            1,
            "residues within 8 A",
            'cmd.select("' + sele + '","(byres (' + sele + ' around 8))",enable=1)',
        ],
        [
            1,
            "residues within 12 A",
            'cmd.select("' + sele + '","(byres (' + sele + ' around 12))",enable=1)',
        ],
        [
            1,
            "residues within 20 A",
            'cmd.select("' + sele + '","(byres (' + sele + ' around 20))",enable=1)',
        ],
    ]
...
def extend(self_cmd, sele):
    return [
        ...
        [
            1,
            "by 1 bond",
            'cmd.select("' + sele + '","(' + sele + ' extend 1)",enable=1)',
        ],
        [
            1,
            "by 2 bonds",
            'cmd.select("' + sele + '","(' + sele + ' extend 2)",enable=1)',
        ],
        [
            1,
            "by 3 bonds",
            'cmd.select("' + sele + '","(' + sele + ' extend 3)",enable=1)',
        ],
        [
            1,
            "by 4 bonds",
            'cmd.select("' + sele + '","(' + sele + ' extend 4)",enable=1)',
        ],
        [
            1,
            "by 5 bonds",
            'cmd.select("' + sele + '","(' + sele + ' extend 5)",enable=1)',
        ],
        [
            1,
            "by 6 bonds",
            'cmd.select("' + sele + '","(' + sele + ' extend 6)",enable=1)',
        ],
        [0, "", ""],
        [
            1,
            "by 1 bond, residues",
            'cmd.select("' + sele + '","(byres (' + sele + ' extend 1))",enable=1)',
        ],
        [
            1,
            "by 2 bonds, residues",
            'cmd.select("' + sele + '","(byres (' + sele + ' extend 2))",enable=1)',
        ],
        [
            1,
            "by 3 bonds, residues",
            'cmd.select("' + sele + '","(byres (' + sele + ' extend 3))",enable=1)',
        ],
        [
            1,
            "by 4 bonds, residues",
            'cmd.select("' + sele + '","(byres (' + sele + ' extend 4))",enable=1)',
        ],
        [
            1,
            "by 5 bonds, residues",
            'cmd.select("' + sele + '","(byres (' + sele + ' extend 5))",enable=1)',
        ],
        [
            1,
            "by 6 bonds, residues",
            'cmd.select("' + sele + '","(byres (' + sele + ' extend 6))",enable=1)',
        ],
    ]
...
def polar(self_cmd, sele):
    return [
        ...
        [
            ...
            + '","'
            + sele
            + '",quiet=1,mode=2,label=0,reset=1);cmd.enable("'
            + sele
            + '_polar_conts")',
        ],
        [
            ...
            + ')","('
            + sele
            + ') & sc.",quiet=1,mode=2,label=0,reset=1);cmd.enable("'
            + sele
            + '_polar_conts")',
        ],
        [
            ...
            + ') and solvent","('
            + sele
            + ') and not (solvent)",quiet=1,mode=2,label=0,reset=1);cmd.enable("'
            + sele
            + '_polar_conts")',
        ],
        [
        ...
        [
            ...
            + ')","('
            + sele
            + ') & !bb.",quiet=1,mode=2,label=0,reset=1);cmd.enable("'
            + sele
            + '_polar_conts")',
        ],
        [
        ...
        if a != sele:
            result.append(
                [
                    1,
                    a,
                    'cmd.align("polymer and name CA and ('
                    + sele
                    + ')",'
                    + '"polymer and name CA and ('
                    + a
                    + ')",quiet=0,'
...
def mat_tran(self_cmd, sele, direction=0):
    ...
    for a in list:
        if a != sele:
            if direction:
                result.append(
                    [1, a, 'cmd.matrix_transfer("' + a + '","' + sele + '");']
                )
            else:
                result.append(
                    [1, a, 'cmd.matrix_transfer("' + sele + '","' + a + '");']
                )
    return result
...
def map_slice(self_cmd, sele):
    return [
        ...
        [
            ...
            + sele
            + '_slice");'
            + 'cmd.set("slice_track_camera",1,"'
            + sele
            + '_slice");'
            + 'cmd.set("two_sided_lighting",1,"'
            + sele
            + '_slice");'
            + 'cmd.set("ray_interior_color",0,"'
            + sele
            + '_slice");'
            + 'cmd.set("slice_dynamic_grid",1,"'
            + sele
            + '_slice")',
        ],
    ]
...
def all_action(self_cmd, sele):
    return [
        ...
        [
            1,
            del_col + "delete selections",
            'map(cmd.delete,cmd.get_names("selections"))',
        ],
        [0, "", ""],
...
def label_props(self_cmd, sele):
    return [
        ...
        [
            ...
            'cmd.label("'
            + sele
            + "\",\"('%+d'%formal_charge) if formal_charge else ''\")",
        ],
        [0, "", ""],
        [
            1,
...
def enable_disable(self_cmd, enable):
    ...
    if enable:
        result = [[2, "Enable", ""]]
        cmmd = "enable "
        names = [ob for ob in self_cmd.get_names("objects") if ob not in names_enabled]
    else:
        result = [[2, "Disable", ""]]
        cmmd = "disable "
        names = names_enabled
    ...
    with menucontext(self_cmd, sele2):
        return [
            ...
            [
                1,
                "molecule",
                pick_option(self_cmd, "(bymol (" + sele2 + "))", "Molecule"),
            ],
            [0, "", ""],
            [
                1,
                "fragment",
                pick_option(self_cmd, "(byfrag (" + sele2 + "))", "Fragment"),
            ],
            [
                1,
                "fragment+joint(s)",
                pick_option(
                    self_cmd, "((byfrag (" + sele2 + ")) extend 1)", "Fragment"
                ),
            ],
        ]
