...
def mol_color(s):
   return [[ 2, 'Color:'     ,''                               ],
           [ 1, 'elem `292C`777H`229N`922O`950S`905*'  , 'util.cbag("'+s+'")'],
           [ 1, 'elem `099C`777H`229N`922O`950S`905*'  , 'util.cbac("'+s+'")'],
           [ 1, 'elem `909C`777H`229N`922O`950S`905*'  , 'util.cbam("'+s+'")'],           
           [ 1, 'elem `990C`777H`229N`922O`950S`905*'  , 'util.cbay("'+s+'")'],
           [ 1, 'elem `955C`777H`229N`922O`950S`905*'  , 'util.cbas("'+s+'")'],
           [ 1, 'elem `777C`777H`229N`922O`950S`905*'  , 'util.cbaw("'+s+'")'],
           [ 1, 'elem `559C`777H`229N`922O`950S`905*'  , 'util.cbab("'+s+'")'],
           [ 1, 'elem `972C`777H`229N`922O`950S`905*'  , 'util.cbao("'+s+'")'],
           [ 1, 'elem  `777H`229N`922O`950S`905*'  , 'util.cnc("'+s+'")'],                      
           [ 0, ''                                , ''                 ],
