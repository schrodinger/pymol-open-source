    ...
    def ray_tracing(self, conditions, width=640, height=480):
        ...
        for cond in conditions:
            ...
            while elapsed < self.long_cpu:
                ...
                elapsed = time.time() - start
            self.report(
                "RAY_V2_PX%d_TH%02d_HSH%03d" % (width * height, max_threads, hash_max),
                60 * cnt / elapsed,
            )
    ...
    def get_panel(self):
        return [
            ...
            [
                2,
                "Surface Calculation",
                'cmd.get_wizard().delay_launch("surface_calculation")',
            ],
            [
                2,
                "Mesh Calculation",
                'cmd.get_wizard().delay_launch("mesh_calculation")',
            ],
