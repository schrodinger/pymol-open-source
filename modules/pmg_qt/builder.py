...
class SculptWizard(ActionWizard):
    ...
    def sculpt_deactivate(self):
        if (
            self.sculpt_object is not None
        ) and self.sculpt_object in self.cmd.get_names():
...
class _BuilderPanel(QtWidgets.QWidget):
        ...
        buttons = [
            [
                ...
                (
                    "-CF3",
                    "Trifluoromethane",
                    lambda: self.grow("trifluoromethane", 4, 0, "trifluoro"),
                ),
            ...
            [
                ...
                (
                    "C=ON",
                    "C->N amide",
                    lambda: self.grow("formamide", 5, 0, "C->N amide"),
                ),
                (
                    "NC=O",
                    "N->C amide",
                    lambda: self.grow("formamide", 3, 1, "N->C amide"),
                ),
                ("S=O2", "Sulfone", lambda: self.grow("sulfone", 3, 1, "sulfonyl")),
                (
                    "P=O3",
                    "Phosphite",
                    lambda: self.grow("phosphite", 4, 0, "phosphoryl"),
                ),
            ...
            [
                (
                    "#cyc3",
                    "Cyclopropane",
                    lambda: self.grow("cyclopropane", 4, 0, "cyclopropyl"),
                ),
                (
                    "#cyc4",
                    "Cyclobutane",
                    lambda: self.grow("cyclobutane", 4, 0, "cyclobutyl"),
                ),
                (
                    "#cyc5",
                    "Cyclopentane",
                    lambda: self.grow("cyclopentane", 5, 0, "cyclopentyl"),
                ),
                (
                    "#cyc6",
                    "Cyclohexane",
                    lambda: self.grow("cyclohexane", 7, 0, "cyclohexyl"),
                ),
                (
                    "#cyc7",
                    "Cycloheptane",
                    lambda: self.grow("cycloheptane", 8, 0, "cycloheptyl"),
                ),
                (
                    "#aro5",
                    "Cyclopentadiene",
                    lambda: self.grow("cyclopentadiene", 5, 0, "cyclopentadienyl"),
                ),
                ...
                (
                    "#aro66",
                    "Napthylene",
                    lambda: self.grow("napthylene", 13, 0, "napthyl"),
                ),
                (
                    "#aro67",
                    "Benzocycloheptane",
                    lambda: self.grow("benzocycloheptane", 13, 0, "benzocycloheptyl"),
                ),
            ],
        ]
        ...
        buttons = [
            ...
            [
                ...
                (
                    ...
                    lambda: self.setOrder("4", "aromatic"),
                ),
                ("@   Model:", None, None),
            ...
            [
                (
                    "$El-stat",
                    "Electrostatics term for 'Clean' action",
                    "clean_electro_mode",
                ),
                ("@   ", None, None),
    ...
    def clear(self):
        ...
        check = QMB.question(
            None, "Confirm", "Really delete everything?", QMB.Yes | QMB.No
        )
        if check == QMB.Yes:
            self.cmd.delete("all")
            self.cmd.refresh_wizard()
