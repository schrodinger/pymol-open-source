...
void SettingInitGlobal(PyMOLGlobals *G,int alloc,int reset_gui)
{
  ...
  SettingSet_b(I,cSetting_cull_spheres,  G->Option->sphere_mode<0);
  ...
  SettingSet_b(I,cSetting_auto_show_lines, G->Option->sphere_mode<0);
  ...
  SettingSet_f(I,cSetting_ray_trace_fog_start, -1.0F);

  SettingSet_f(I,cSetting_spheroid_smooth, 1.1F);

  SettingSet_f(I,cSetting_spheroid_fill, 1.30F);

  SettingSet_b(I,cSetting_auto_show_nonbonded, G->Option->sphere_mode<0);
  ...
  */
  ...
  SettingSet_f(I,cSetting_ray_direct_shade,0.0F);  /* only meaningful with one light source */
  ...
  SettingSet_b(I,cSetting_pqr_workarounds, 1);
  ...
  SettingSet_i(I,cSetting_label_shadow_mode, 0);
  SettingSet_3f(I,cSetting_light4, -1.2F, 0.3F, -0.2F);
