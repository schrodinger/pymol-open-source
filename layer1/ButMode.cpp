...
bool ButModeDrawFastImpl(Block * block, short definitely ORTHOCGOARG);
/*========================================================================*/
    ...
    if(SettingGetGlobal_b(G, cSetting_mouse_grid)) {
      ...
      for(a = 0; a < 3; a++) {
        ...
        if(mode < 0)
          ...
          TextDrawStr(G, Code[mode] ORTHOCGOARGVAR);
      }
      mode = Mode[12];
      if(mode < 0)
        TextDrawStr(G, BLANK_STR ORTHOCGOARGVAR);
