...
float *RepCylinder(float *v, float *v1, float *v2, int nEdge,
                   int frontCap, int endCap, float tube_size, float overlap, float nub);
  ...
  case 2:
    {
      ...
      if(!half_bonds) {
        ...
        v = RepCylinder(v, v1t, v2t, n_edge, 1, 1, radius, overlap_r, nub_r);
        n++;
        ...
        *(vr++) = radius;
        ...
        if(color1) {
          ...
          v = RepCylinder(v, v1t, v2t, n_edge, 1, 0, radius, overlap_r, nub_r);
          n++;
      ...
      if(!half_bonds) {
        ...
        *(vr++) = radius;
        ...
        if(color1) {
          ...
          copy3f(v1, v1t);
          v = RepCylinder(v, v1t, vh, n_edge, 1, 0, radius, overlap_r, nub_r);
          n++;
        ...
        if(color2) {
          ...
          copy3f(v2, v2t);
          v = RepCylinder(v, v2t, vh, n_edge, 1, 0, radius, overlap_r, nub_r);
          n++;
  ...
  case 4:
    {
      ...
      if(!half_bonds) {
        ...
        *(vr++) = radius2;
        ...
        v = RepCylinder(v, v1tt, v2tt, n_edge, 1, 1, radius2, overlap_r2, nub_r2);
        n++;
          ...
          if((bd_valence_flag) && (ord > 1) && (ord < 5)) {
            ...
            if((c1 == c2) && s1 && s2 && (!ColorCheckRamped(G, c1))) {
              ...
              RepValence(&v, &I->N,
                         ...
                         a1, a2, cs->Coord,
                         v0, NULL, ord, nEdge,
                         bd_radius, overlap, nub, false, fixed_radius, scale_r);
            } else {
              rgb1 = NULL;
              if(s1) {
              ...
              RepValence(&v, &I->N,
                         ...
                         a1, a2, cs->Coord,
                         rgb1, rgb2, ord, nEdge,
                         bd_radius, overlap, nub, true, fixed_radius, scale_r);
            }
            ...
            if((c1 == c2) && s1 && s2 && (!ColorCheckRamped(G, c1))) {
              ...
              *(vr++) = bd_radius;
              ...
              /* generate a cylinder */
              v =
                RepCylinder(v, v1, v2, nEdge, caps_req, caps_req, bd_radius, overlap_r,
                            nub_r);
            } else {
              v1[0] = vv1[0];
              v1[1] = vv1[1];
              ...
              if(s1) {
                ...
                *(v++) = *(v0++);
                ...
                I->N++;
                v =
                  RepCylinder(v, v1, v2, nEdge, caps_req, 0, bd_radius, overlap_r, nub_r);
              }
...
static void RepCylinderImmediate(float *v1, float *v2, int nEdge,
                                 ...
                                 float overlap, float nub, float *x, float *y)
{
  float d[3], t[3], p0[3], p1[3], p2[3];
  float vv1[3], vv2[3];
        ...
        if((ai1 = ai + b1)->visRep[cRepCyl] && (ai2 = ai + b2)->visRep[cRepCyl]) {
          ...
          if((a1 >= 0) && (a2 >= 0)) {
            ...
            if(c1 == c2) {      /* same colors -> one cylinder */
              ...
              RepCylinderImmediate(v1, v2, nEdge, 1, 1, overlap_r, nub_r, x, y);
              ...
              RepCylinderImmediate(v1, avg, nEdge, 1, 0, overlap_r, nub_r, x, y);
              ...
              RepCylinderImmediate(v2, avg, nEdge, 1, 0, overlap_r, nub_r, x, y);
            }
          }
        }
      }
